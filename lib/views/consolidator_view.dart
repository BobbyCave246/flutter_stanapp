...
import 'package:flutterstanapp/views/capital_secure_view.dart';
import 'package:flutterstanapp/views/test_view.dart';
import 'package:provider/provider.dart';

class ConsolidatorView extends StatelessWidget {
  @override
        ...
        children: <Widget>[
          StreamBuilder<DocumentSnapshot>(
              stream: Firestore.instance
                  ...
                  .document('Conservative Consolidator Share')
                  .snapshots(),
                ...
                children: <Widget>[
                  ...
                  FlatButton(
                    onPressed: () {
                      Navigator.of(context).push(
                        new MyCustomRoute(
                            builder: (context) => new CapitalSecureView()),
                      );
                    },
                    child: Container(
                      decoration: BoxDecoration(
